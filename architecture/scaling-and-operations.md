...
- EKS 구축 사전 준비
- VPC / Subnet / NAT / Route Table 구성 기준
- IAM Role / Worker Node Role 생성
- OIDC / IRSA 적용 절차
- AWS Load Balancer Controller 설치
- Cluster Autoscaler 설치
- Metrics Server 적용
- CloudFront / WAF 접근 제어 기준
- CodeBuild / Manifest Repository / ArgoCD 배포 흐름
- aws-auth 권한 추가
- Local kubeconfig 구성
- 운영 접근 및 기본 점검 절차
...
실제로는 노션에 구축 절차와 운영 기준을 계속 정리해 두면서, 특정 작업이 개인 기억에만 남지 않도록 관리했습니다. 이 포트폴리오는 그 문서화 경험을 공개 가능한 형태로 다시 정리한 결과물입니다.
